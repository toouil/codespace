...
import { CommentIcon, Like, World, Lock } from "@/assets/icons";
                ...
                <div className="post_header_user">
                    ...
                    <div className="user_post_details">
                        ...
                        <span className="post_details_date">
                            ...
                            <span className="post_visibility" data-title={visibility}>
                                {
                                    visibility == "public" ? <World data-title={visibility} /> : <Lock data-title={visibility} />
                                }
                            </span>
                        </span>
                    </div>
